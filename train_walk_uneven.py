...
def main():
    ...
    if args.debug:
        ...
        args.offline = True
        args.num_envs = 1
    logger.info("Initializing genesis backend")
    gs.init(
    ...
    logger.info("Initializing OnPolicyRunner")
    ...
    logger.info("Saving configurations to pickle file")
    pickle.dump(
        [env_cfg, obs_cfg, reward_cfg, command_cfg],
        open(f'{log_dir}/cfgs.pkl', 'wb'),
    )

    logger.info(f"Starting training for {args.max_iterations} iterations")
