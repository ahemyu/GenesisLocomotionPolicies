...
def main():
    ...
    env_cfg, obs_cfg, reward_cfg, train_cfg, command_cfg = pickle.load(open(f"logs/{args.exp_name}/cfgs.pkl", "rb"))
...
"""
python eval_run.py -e go2-running-curriculum -r --ckpt 1000
"""
